...
const socials = [
	...
	{
		icon: <Mail size={20} />,
		href: "mailto:codenidhish07@gmail.com",
		label: "Email",
		handle: "codenidhish07@gmail.com",
	},
	{
		icon: <Github size={20} />,
						...
						<Card key={index}>
							...
							>
								...
								<div className="z-10 flex flex-col items-center">
									...
									<span className="mt-4 text-xs text-center duration-1000 text-zinc-400 group-hover:text-zinc-200">
										{s.label}
									</span>
								</div>
							</Link>
